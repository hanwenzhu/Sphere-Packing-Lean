...
@[blueprint
  ...
  (proof := /-- Follows from the definition of the slash operator: $(F|_{k}(-I))(z) = (-1)^{-k}F((-I)z) = F(z)$. -/)
  (latexEnv := "lemma")]
...
attribute [blueprint
  ...
  -/)
  (uses := ["def:level-N-princ-cong-subgp"])] ModularGroup.S

/-- We have $\Gamma(1) = \langle S, T, -I \rangle$. -/
@[blueprint
  (proof := /-- See [first] [course], Exercise 1.1.1. -/)
  (latexEnv := "lemma")]
...
@[blueprint
  (proof := /-- See [first] [course], Exercise 1.2.4. -/)
  (latexEnv := "lemma")]
