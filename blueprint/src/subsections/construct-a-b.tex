...
\uses{ModularForm.eisensteinSeries_MF, E₂_eq}
\begin{align}
...
\begin{lemma}\label{lemma:phi0-transform}\uses{def:phi4-phi2-phi0, EisensteinSeries.eisensteinSeries_SIF, E₂_transform, Delta}
We have
\begin{align}
...
\inputleannode{MagicFunction.a.RadialFunctions.a}
...
\inputleannode{MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff}
...
\begin{corollary}\label{cor:phi0-bound}\uses{ramanujan_E₂, MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff, E_k_q_expansion, lemma:mod_form_poly_growth}
...
\end{equation}
Then the result follows from Lemma~\ref{MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff} with $f(z) = (E_2 E_4 - E_6)^2$ and $n_0 = 4$.
\end{proof}

\begin{corollary}\label{cor:phi2-bound}\uses{def:phi4-phi2-phi0, MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff, E_k_q_expansion}
...
\begin{corollary}\label{cor:phi4-bound}\uses{def:phi4-phi2-phi0, MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff, E_k_q_expansion}
...
\inputleannode{MagicFunction.FourierEigenfunctions.a}


\inputleannode{MagicFunction.a.Fourier.eig_a}
...
\uses{cor:phi0-near-0-infty, MagicFunction.a.RadialFunctions.a, Δ_ne_zero}
...
\begin{proposition}\label{prop:a-another-integral}\uses{prop:a-double-zeros, def:phi4-phi2-phi0, lemma:phi0-transform, MagicFunction.a.RadialFunctions.a}
For $r\geq0$ we have
...
\inputleannode{MagicFunction.a.SpecialValues.a_zero}
...
\begin{lemma}\label{lemma:psiI-psiT-psiS-fourier}\uses{ψI_eq}
...
\begin{lemma}\label{lemma:psiS-new}\uses{ψI_eq, lemma:lv1-lv2-identities, lemma:jacobi-identity}
...
\begin{lemma}\label{lemma:psiS-bound}\uses{lemma:psiS-new, MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff, prop:H2-fourier, prop:H3-fourier, prop:H4-fourier}
...
Now the result follows from Lemma \ref{MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff}.
\end{proof}

\inputleannode{MagicFunction.FourierEigenfunctions.b}


\inputleannode{MagicFunction.b.Fourier.eig_b}

Now we regard the radial function $b$ as a function on $\R_{\geq0}$. We check that $b$ has double roots at $\Lambda_8$-points.

\begin{lemma}\label{lemma:psiI-bound}\uses{MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff, prop:H2-fourier, prop:H3-fourier, prop:H4-fourier, def:psiI-psiT-psiS, H₂_T_action, Delta}
...
\end{equation}
The denominator is not a cusp form (i.e. has a nonzero constant term), hence Lemma \ref{MagicFunction.PolyFourierCoeffBound.DivDiscBoundOfPolyFourierCoeff} concludes the proof with $n_0 = 0$.
\end{proof}
...
\begin{proposition}\label{prop:b-double-zeros}\uses{lemma:psiI-psiT-psiS-fourier, def:psiI-psiT-psiS, cor:psiI-near-0-infty, Δ_ne_zero}
...
\inputleannode{MagicFunction.b.SpecialValues.b_zero}